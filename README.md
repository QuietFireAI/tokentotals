...
TokenTotals normalizes all LLM costs across **Anthropic** (**Claude 3.7 Sonnet**), **OpenAI** (**GPT-6 Astra** / **GPT-5.6 Terra** / **GPT-5.6 Luna**), and **Google** (**Gemini 3.7 Flash** / **Gemini 2.5 Pro**):
